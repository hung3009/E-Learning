      ...
      <div className="w-full 800px:flex items-center">
        ...
        <div className="800px:w-[50%] w-full">
          ...
          <p className={styles.label}>
            At <span className="text-gradient">Elearning</span> , we take immense pride in the quality of
            education we provide. Our programming courses are designed to equip
            students with the knowledge and skills they need to succeed in the
            dynamic world of technology. But do not just take our word for
            it—listen to what our students have to say about their experiences
            with our programming courses.
          </p>
        </div>
        <br />
        <br />
