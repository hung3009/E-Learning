    ...
    <div className="text-black dark:text-white">
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          That&apos;s why I created ELearning &ndash; to provide new programmers
          ...
          <br />
          <br />
          But ELearning is more than just a community &ndash; we&apos;re a
        ...
        <br />
        <span className="text-[22px]">HungNguyen&apos;s</span>
