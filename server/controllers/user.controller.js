...
exports.updateAccessToken = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!session) {
            return next(new ErrorHandler_1.ErrorHandler('Please login for access this resources!', 400));
        }
        ...
        yield redis_1.redis.set(user._id, JSON.stringify(user), "EX", 604800); // expires after 7 day
        next();
    }
    catch (error) {
        return next(new ErrorHandler_1.ErrorHandler(error.message, 400));
...
exports.updatePassword = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!oldPassword || !newPassword) {
            return next(new ErrorHandler_1.ErrorHandler("Please enter old and new password", 400));
        }
